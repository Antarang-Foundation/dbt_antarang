with t1 as (
    select distinct school_name, batch_no,school_academic_year, school_district,
...
where session_name like '%01%' and school_academic_year is not null
group by school_name, batch_no,total_student_present, session_date,school_academic_year,school_district
), 
...
t2 as (
   select distinct school_name,
    ...
    from t1
    group by school_name,school_academic_year,school_district
)

select 
school_name,
school_academic_year, school_district, Total_batches,
