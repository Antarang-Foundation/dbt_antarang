...
batch_max_session_parent_attendance, batch_max_session_counseling_attendance,
...
batch_academic_year, batch_grade, session_grade, batch_language, fac_start_date, fac_end_date, no_of_students_facilitated, batch_max_student_session_attendance, batch_max_session_parent_attendance,batch_max_session_counseling_attendance,
batch_expected_sessions, batch_scheduled_sessions, batch_completed_sessions, session_type)
