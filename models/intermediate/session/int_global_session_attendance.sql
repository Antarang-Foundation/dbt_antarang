...
t4 as (select * from t1 full outer join t2 on t1.batch_id = t2.session_batch_id order by batch_id),
t5 as (select * from t4 full outer join t3 on t4.student_id = t3.attendance_student_id order by batch_id)
...
tagged_for_counselling, school_partner, school_area, batch_donor, attendance_id, attendance_session_id, attendance_no, attendance_status, attendance_date, attendance_time, guardian_attendance */
