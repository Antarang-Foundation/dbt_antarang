...
t2 as(
select student_barcode, student_name, batch_no, batch_donor, school_partner, school_state, school_district, school_taluka, school_name, school_area, facilitator_name, batch_academic_year, batch_grade, session_grade, batch_language, 
