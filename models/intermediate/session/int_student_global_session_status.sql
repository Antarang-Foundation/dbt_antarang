...
t2 as(
select student_barcode, student_name, batch_no, batch_donor, school_partner, school_state, school_district, school_ward, school_taluka, school_name, school_area, facilitator_name, batch_academic_year, batch_grade, session_type, session_grade, batch_language, 
...
FROM t1
group by student_barcode, student_name, batch_no, batch_donor, school_partner, school_state, school_district, school_ward, school_taluka, school_name, school_area, facilitator_name, batch_academic_year, batch_grade, session_type, session_grade, batch_language 
)
select * from t2 
