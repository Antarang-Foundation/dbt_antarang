with
    t0 as (
        SELECT 
                ...
                cdm2_total_marks, batch_id, record_type
    ...
    t1 as (
        ...
        from t0
            PIVOT (
            max(cdm2_no) as cdm2_no, max(batch_id) as batch_id, max(q5) as q5, max(q5_marks) as q5_marks, max(q6_1) as q6_1, max(q6_1_marks) as q6_1_marks,
