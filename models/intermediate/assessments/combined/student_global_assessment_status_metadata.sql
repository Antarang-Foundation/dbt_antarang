...
t0 as (select * from {{ ref("int_student_global_assessment_status") }}),
...
t3 as (select 's4. int_student_global_assessment_status' as table_name, column_name, (select count (*) from t0) as total_records, 
...
assessment_metadata as (select table_name, column_name, total_records, null_count, (total_records - null_count) as nonnull_count, distinct_count, (total_records - distinct_count) as duplicate_count, 
...
select * from assessment_metadata where column_name != ""
