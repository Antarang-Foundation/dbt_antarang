...
t0 as (select * from {{ ref("int_student_global_assessment") }}),
...
t3 as (select 's3. int_student_global_assessment' as table_name, column_name, (select count (*) from t0) as total_records, 
