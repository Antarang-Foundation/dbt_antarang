with
    ...
    t1 as (select student_id, student_barcode, student_grade, gender, caste, student_batch_id, batch_id, batch_no, batch_academic_year, batch_grade, batch_language,
    ...
    school_ward, school_district, school_state, school_partner, school_area, batch_donor_id, donor_id, batch_donor  
    from {{ ref("int_student_global") }}),
    t2 as (select * from {{ ref("int_cdm1_latest") }}),
