with
    t0 as (
        SELECT 
                ...
                q17, q17_marks, q18_1, q18_2, q18_3, q18_4, q18_5, q18_6, q18_7, q18_8, q18_9, q18_10, q18_11, q18_marks, 
    ...
    t1 as (
        ...
        from t0
            ...
            max(assessment_grade) as assessment_grade, max(assessment_batch_id) as assessment_batch_id, max(fp_no) as fp_no, 
...
fp_no_Baseline as bl_fp_no, is_non_null_Baseline as bl_is_non_null,
...
fp_no_Endline as el_fp_no, is_non_null_Endline as el_is_non_null,
