with
    t0 as (
        SELECT 
                ...
                q9_6, q9_6_marks, q9_7, q9_7_marks, q10, q10_marks, cp_total_marks, batch_id, record_type, created_on, grade, academic_year, created_from_form
    ...
    t1 as (
        ...
        from t0
            PIVOT (
            max(cp_no) as cp_no, max(batch_id) as batch_id, max(created_on) as created_on, max(created_from_form) as created_from_form,
