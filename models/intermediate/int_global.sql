with
    ...
    int_global as (
        ...
        school_name as school, school_taluka_id, school_ward_id, school_district_id, school_state_id, school_academic_year, school_language, enrolled_g9, 
        enrolled_g10, enrolled_g11, enrolled_g12, tagged_for_counselling, school_partner, donors.donor_name as batch_donor
        from 
            batches
