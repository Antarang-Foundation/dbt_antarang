with
    ...
    t3 as (select batch_id, batch_no, batch_academic_year, batch_grade, batch_language, batch_trainer_name, school, school_district, school_state, 
    ...
    select * from t4 order by contact_id, uid, contact_grade, contact_barcode, contact_batch_id
