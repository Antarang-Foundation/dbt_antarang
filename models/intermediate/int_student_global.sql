with
    ...
    t3 as (select t1.*, t2.batch_id as global_batch_id, t2.* except(batch_id) from t1 left join t2 on t1.contact_batch_id = t2.batch_id order by t1.contact_batch_id)
