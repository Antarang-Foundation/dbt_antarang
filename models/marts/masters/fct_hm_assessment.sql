...
(select s.hm_session_name, s.facilitator_name, s.hm_session_date, s.start_time, s.Others_Please_Specify,
  ...
  s.ques_school_osmanabad, s.ques_school_yamunanagar, s.Q17_materials_that_apply, s.pre_how_did_you_hear, s.Q8_which_grade,
s.Q9_which_follow, s.Q10_which_follow, s.Q5_grade, s.Q6_which_follow, s.Q7_role, s.Q8_materials, s.post_how_did_you_hear,
s.Q8_in_which_grade, s.Q9_which_of_the_following, s.Q10_answer_that_apply,
...
case when Q10_which_follow like '%arranged_additional_career_activities_in%' then 1 else 0 end as Q10k_pre_arranged_additional_career_activities_in,
case when Q10_which_follow like '%spoke_to_my_school_alumni_to_see_how_the%' then 1 else 0 end as Q10l_pre_spoke_to_my_school_alumni_to_see_how_the,
case when Q10_which_follow like '%ensured_there_is_a_trained_career_teache%' then 1 else 0 end as Q10m_pre_ensured_there_is_a_trained_career_teache,
case when Q10_which_follow like '%i_do_not_know__not_sure%' then 1 else 0 end as Q10n_pre_i_do_not_know__not_sure,
...
case when Q10_answer_that_apply like '%Gave_ideas_or_suggestions_to_the_career_teacher%' then 1 else 0 end as Q10f_post_Gave_ideas_or_suggestions_to_the_career_teacher,
case when Q10_answer_that_apply like '%Shared_updates_in_meetings_or_reports%' then 1 else 0 end as Q10g_post_Shared_updates_in_meetings_or_reports,
case when Q10_answer_that_apply like '%Utilised_school_funds_for_the_program%' then 1 else 0 end as Q10h_post_Utilised_school_funds_for_the_program,
case when Q10_answer_that_apply like '%Talked_often_with_the_career_teacher%' then 1 else 0 end as Q10i_post_Talked_often_with_the_career_teacher,
case when Q10_answer_that_apply like '%Started_and_ended_the_program_on_time%' then 1 else 0 end as Q10ij_post_Started_and_ended_the_program_on_time,
case when Q10_answer_that_apply like '%Arranged_extra_career_activities%' then 1 else 0 end as Q10k_post_Arranged_extra_career_activities,
case when Q10_answer_that_apply like '%invited_ex-students_to_share_their_job_stories%' then 1 else 0 end as Q10l_post_invited_ex_students_to_share_their_job_stories,
case when Q10_answer_that_apply like '%Fixed_a_regular_time_for_career_sessions%' then 1 else 0 end as Q10m_post_Fixed_a_regular_time_for_career_sessions,
case when Q10_answer_that_apply like '%i_do_not_know__not_sure%' then 1 else 0 end as Q10n_post_i_do_not_know__not_sure,
...
select school_name, session_academic_year, batch_language, school_taluka, school_district,
school_state, school_area, school_partner, pre_start, pre_end, pre_date, district_name, Q4_years_in_this_school, Q5_organisation_last_year, Q5_option_1, Q5_option_2,
Q5_option_3, Q6_heard_of_antarang, pre_how_did_you_hear, Q7a_newspapers, Q7b_pre_social_media__facebook__linked, Q7c_pre_from_government_meetings___oth,
Q7d_pre_from_parents__students, Q7e_pre_search_engines___google_etc, Q7f_pre_worked_with_them_in_the_past,
Q7g_pre_workshops__training_sessions__, Q7h_pre_other__please_specify, Q7i_pre_NA, Other_Please_Specify, Q8_which_grade,
Q8a_pre_grade_8,
...
Q10f_post_Gave_ideas_or_suggestions_to_the_career_teacher,
Q10g_post_Shared_updates_in_meetings_or_reports,
Q10h_post_Utilised_school_funds_for_the_program,
Q10i_post_Talked_often_with_the_career_teacher,
Q10ij_post_Started_and_ended_the_program_on_time,
Q10k_post_Arranged_extra_career_activities,
Q10l_post_invited_ex_students_to_share_their_job_stories,
Q10m_post_Fixed_a_regular_time_for_career_sessions,
Q10n_post_i_do_not_know__not_sure,
