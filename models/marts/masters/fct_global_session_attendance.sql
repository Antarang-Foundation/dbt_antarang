select * from {{ref('int_global_session_attendance')}}

/* t2 as(select batch_no AS session_batch_no , batch_max_session_attendance, batch_max_session_parent_attendance, batch_max_session_counseling_attendance, batch_expected_sessions, 
