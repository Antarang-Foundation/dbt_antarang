with
    ...
    SELECT *,
        CASE
            WHEN TRIM(student_details_2_grade) LIKE '%Grade 12%'
                THEN 'Grade 12'

            WHEN TRIM(student_details_2_grade) LIKE '%Grade 11%'
                THEN 'Grade 11'

            WHEN TRIM(student_details_2_grade) LIKE '%Grade 10%'
                THEN 'Grade 10'

            WHEN TRIM(student_details_2_grade) LIKE '%Grade 9%'
                THEN 'Grade 9'
        END AS sd2_grade
    FROM t2
),
