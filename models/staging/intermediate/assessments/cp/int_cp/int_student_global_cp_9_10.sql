with
    dcp as (
        ...
        where
            safe_cast(batch_academic_year as int64) >= 2026
            and batch_grade in ('Grade 9', 'Grade 10')
    ...
    cp as (
        select
            ...
            a_q8_c1 as q4_8_1,
            a_q8_c1_ans as q4_8_1_ans,
            a_q8_c2 as q4_8_2,
            a_q8_c2_ans as q4_8_2_ans,
            q2 as q4_9,
    ...
    bl as (select * from cp where record_type = 'Baseline'),

    el as (select * from cp where record_type = 'Endline'),
    ...
    final as (
        select
            ...
            bl.q4_8_1_ans as bl_q4_8_1_ans,
            bl.q4_8_2 as bl_q4_8_2,
            bl.q4_8_2_ans as bl_q4_8_2_ans,
            bl.q4_9 as bl_q4_9,
            ...
            el.q4_8_1_ans as el_q4_8_1_ans,
            el.q4_8_2 as el_q4_8_2,
            el.q4_8_2_ans as el_q4_8_2_ans,
            el.q4_9 as el_q4_9,
        ...
        left join bl on bl.assessment_barcode = dcp.student_barcode

        left join el on el.assessment_barcode = dcp.student_barcode
        where
