with
    ...
    school_ward, school_district, school_state, school_partner, school_area, batch_donor_id, donor_id, batch_donor,no_of_students_facilitated, sd2_grade, sd2_barcode  
    from {{ ref("int_student_global") }}),
    t2 as (select * from {{ ref("int_assessment") }}),
