...
t1 as (
    select 
        ...
        allocation_email_sent, batch_facilitator_id, facilitator_id, facilitator_name, facilitator_email, joining_date,
...
t4 as (
    select 
        ...
        case
            when t3.session_mode = 'Any' 
                 and t3.school_district = 'RJ Model B'
            then 'HW Session'
            else t3.session_type
        end as updated_session_type,
        ...
        case
            ...
            when lower(session_name) like '%01.%'
                 and total_student_present is not null
                 and session_date is not null
            then 'Batch Started'
...
select
    ...
    batch_expected_sessions, batch_expected_student_type_session, batch_expected_parent_type_session, 
    batch_expected_flexible_type_session, batch_expected_counseling_type_session,
    batch_scheduled_sessions, batch_student_type_scheduled_sessions, batch_parent_type_scheduled_sessions, 
