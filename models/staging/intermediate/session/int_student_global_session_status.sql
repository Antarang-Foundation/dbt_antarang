...
t2 as(
select student_barcode, first_barcode, student_name, gender, batch_no, batch_donor, school_partner, school_state, school_district, school_taluka, school_ward, school_name, school_area, facilitator_name, facilitator_email, batch_academic_year, batch_grade, 
...
FROM t1
group by student_barcode, first_barcode, student_name, gender, batch_no, batch_donor, school_partner, school_state, school_district, school_taluka, school_ward, school_name, school_area, facilitator_name, facilitator_email, 
