...
(Select student_id,	student_barcode, batch_no, batch_academic_year,	batch_grade, batch_language, school_state,	
...
(Select student_id,	student_barcode, gender, batch_no, batch_academic_year,	batch_grade, batch_language, school_state,	
...
aspiration as (SELECT 
   a.student_id, a.student_barcode, a.batch_no, a.batch_academic_year, a.batch_grade, a.batch_language, a.school_state,
   ...
   SELECT
   b.student_id, b.student_barcode, b.batch_no, b.batch_academic_year, b.batch_grade, b.batch_language, b.school_state,
