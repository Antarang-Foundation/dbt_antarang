select distinct student_name, first_barcode, student_barcode, gender, current_barcode, current_batch_no, birth_year, birth_date, g9_whatsapp_no, 
...
where batch_academic_year >= 2023 and student_barcode is not null 
