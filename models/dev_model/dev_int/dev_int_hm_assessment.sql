...
post_program as (
    select 
        pp_date, pp_name, Q5_pp_others_please_specify, {{ clean_kobo_text('Q10_pp_answer_that_apply') }} AS Q10_pp_answer_that_apply, 
        ...
        {{ clean_survey_column('Q15_pp_important_secondary_students') }} as Q16_pp_career_decisions, {{ clean_kobo_text('Q17_pp_materials_that_apply') }} AS Q17_pp_materials_that_apply, 
