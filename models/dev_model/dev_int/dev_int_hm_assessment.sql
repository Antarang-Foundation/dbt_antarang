...
pre_program as (
    select 
      ...
      Q8_pre_Others_Please_Specify,	district_name as Q3_pre_district_name, Q4_pre__years_in_this_school, 
      Q5_pre_organisation_last_year,	
       Q6_pre_heard_of_antarang, Q7_pre_how_did_you_hear, Q8_pre_which_grade, 
       Q9_pre_which_follow, Q10_pre_which_follow,	
       Q11_pre_think_of_career,	Q12_pre_confident_in_career_program, Q13_pre_program_activities, 
...
post_program as (
    select 
        pp_date, pp_name, Q5_pp_others_please_specify, Q10_pp_answer_that_apply, 
         Q11_pp_thin_for_career_program,  Q12_pp_confident, 
         Q13_pp_program_activities,  Q14_pp_program_sessions, 
         Q15_pp_important_secondary_students, 
         Q16_pp_career_decisions,  Q17_pp_materials_that_apply, 
         ...
         Q18D_pp_header, Q19_pp_leave_school, 
        Q20_pp_thin_for_students, 	Q4_pp_how_many_year_in_this_school,	
         Q5_pp_org_our_school_last_year,	
        Q6_pp_heard_of_antarng,	 Q7_pp_how_did_you_hear,  Q8_pp_in_which_grade, 
         Q9_pp_which_of_the_following, pp_id, Q7_pp_other_please_specify,
...
post_questionair as (
    select 
        ...
        Q11C_po_encouraging_students_choosing_careers, 
         ...
         Q11D_po_header, Q12_po_thin_for_students, 
        Q13_po_big_rom_this_orientation, Q14_po_nex_after_this_orientation, Q4_po_heard_of_antarang, 
         Q5_po_grade,  Q6_po_which_follow,  Q7_po_role, Q8_po_materials, 
         Q9_po_confidence, po_id, po_submission_time,
...
case when Q7_pre_how_did_you_hear like '%newspapers%' then 1 else 0 end as Q7a_pre_newspapers,
...
case when Q8_pre_which_grade like '%none_of_the_above%' then 1 else 0 end as Q8f_pre_none_of_the_above,
...
case when Q7_pp_how_did_you_hear like "%From_government_meetings_/_other_NGO's%" then 1 else 0 end as Q7c_pp_From_government_meetings__other,
case when Q7_pp_how_did_you_hear like '%From_Parents/_Students%' then 1 else 0 end as Q7d_pp_From_Parents_Students,
case when Q7_pp_how_did_you_hear like '%Search_Engines_(_Google,etc)%' then 1 else 0 end as Q7e_pp_Search_Engines__Google_etc,
case when Q7_pp_how_did_you_hear like '%Peer_HMs/Teachers%' then 1 else 0 end as Q7f_pp_Peer_HMsTeachers,
...
case when Q7_pp_how_did_you_hear like '%Antarang’s_website%' then 1 else 0 end as Q7j_pp_Antarangs_website,
...
case when Q9_pp_which_of_the_following like '%Record_of_students’_career_plans%' then 1 else 0 end as Q9g_pp_Record_of_students_career_plans,
...
case when Q9_pp_which_of_the_following like "%Data_collected_on_students'_plans_after_school%" then 1 else 0 end as Q9k_pp_Data_collected_on_students_plans_after_school,
case when Q9_pp_which_of_the_following like '%I’m_not_sure_/_Don’t_know%' then 1 else 0 end as Q9l_pp_i_do_not_know__not_sure,
...
case when Q10_pp_answer_that_apply like '%I’m_not_sure_/_Don’t_know%' then 1 else 0 end as Q10n_pp_i_do_not_know__not_sure,
