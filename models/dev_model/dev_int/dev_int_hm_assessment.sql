...
post_questionair as (
    select 
        ...
        Q13_po_big_rom_this_orientation, Q14_po_nex_after_this_orientation, Q4_po_gender, 
         Q5_po_grade,  Q6_po_which_follow, 
         Q6_po_The_orientation_covered_all_the_key_information_about_the_career_program, Q7_po_role, Q7_po_The_content_was_easy_to_understand,
          Q8_po_materials, Q8_po_The_information_provided_was_relevant_to_my_role,
         Q9_po_confidence, po_id, Q9_po_In_the_next_30_da_take_for_the_program, po_submission_time,
        ...
        school_Osmanabad, school_Yamuna_Nagar) as po_school_names, Q3_district_name as Q3_po_district_name, contact_number as po_contact_number, Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program  
...
pp_date, pp_name, Q5_pp_others_please_specify, Q10_pp_answer_that_apply, 
  ...
  po_date, po_name, Q5_po_others_please_specify, Q10_po_secondary_students, 
        ...
        Q6_po_The_orientation_covered_all_the_key_information_about_the_career_program, Q7_po_The_content_was_easy_to_understand,
        Q8_po_The_information_provided_was_relevant_to_my_role, Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program,
        Q9_po_In_the_next_30_da_take_for_the_program,
...
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%Ensure_timely_start_and_end_of_the_program%' then 1 else 0 end as Q5a_Ensure_timely_start_and_end_of_the_program,
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%Ensure_dedicated_career_period_in_the_timetable%' then 1 else 0 end as Q5b_Ensure_dedicated_career_period_in_the_timetable,
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%Regularly_observe_career_sessions%' then 1 else 0 end as Q5c_Regularly_observe_career_sessions,
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%Ensure_student_participation_in_the_program%' then 1 else 0 end as Q5d_Ensure_student_participation_in_the_program,
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%Share_program_updates_in_HM%' then 1 else 0 end as Q5e_Share_program_updates_in_HM,
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%Promote_discussions_with_parents_about_students%' then 1 else 0 end as Q5f_Promote_discussions_with_parents_about_students,
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%Ensure_a_trained_career_teacher_is_in_place%' then 1 else 0 end as Q5g_Ensure_a_trained_career_teacher_is_in_place,
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%Discuss_student_progress_with_the_career_teacher%' then 1 else 0 end as Q5h_Discuss_student_progress_with_the_career_teacher,
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%Arrange_workplace_visits,_external_speakers,_or_career_fairs_to_provide_students_with_career_exposure%' then 1 else 0 end as Q5i_Arrange_workplace_visits_external_speakers_or_career_fairs_to_provide_students_with_career_exposure,
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%Engage_alumni_to_share_their_career_journeys%' then 1 else 0 end as Q5j_Engage_alumni_to_share_their_career_journeys,
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%Allocate_school_resources/budget_for_the_program%' then 1 else 0 end as Q5k_Allocate_school_resources_budget_for_the_program,
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%Provide_feedback_to_the_career_teacher/facilitator%' then 1 else 0 end as Q5l_Provide_feedback_to_the_career_teacher_facilitator,
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%Attend_training_on_career_guidance_program%' then 1 else 0 end as Q5m_Attend_training_on_career_guidance_program,
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%Share_career-related_information_with_parents%' then 1 else 0 end as Q5n_Share_career_related_information_with_parents,
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%I_am_not_sure_about_my_role%' then 1 else 0 end as Q5o_I_am_not_sure_about_my_role,
case when Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program like '%I_have_no_role_to_play%' then 1 else 0 end as Q5p_I_have_no_role_to_play,

case when Q9_po_In_the_next_30_da_take_for_the_program like '%allocate_timetable_time_for_career_sessi%' then 1 else 0 end as Q9a_allocate_timetable_time_for_career_sessi,
case when Q9_po_In_the_next_30_da_take_for_the_program like '%observe_a_career_session%' then 1 else 0 end as Q9b_observe_a_career_session,
case when Q9_po_In_the_next_30_da_take_for_the_program like '%speak_to_parents_about_the_program%' then 1 else 0 end as Q9c_speak_to_parents_about_the_program,
case when Q9_po_In_the_next_30_da_take_for_the_program like '%identify_a_teacher__poc__to_implement_co%' then 1 else 0 end as Q9d_identify_a_teacher__poc__to_implement_co,
case when Q9_po_In_the_next_30_da_take_for_the_program like '%set_up_a_joint_meeting_with_the_poc_teac%' then 1 else 0 end as Q9e_set_up_a_joint_meeting_with_the_poc_teac,
case when Q9_po_In_the_next_30_da_take_for_the_program like '%review_student_aspiration_data_with_care%' then 1 else 0 end as Q9f_review_student_aspiration_data_with_care,
case when Q9_po_In_the_next_30_da_take_for_the_program like '%attend_program_review__progress_meetings%' then 1 else 0 end as Q9g_attend_program_review__progress_meetings,
case when Q9_po_In_the_next_30_da_take_for_the_program like '%i_need_more_information_before_i_can_tak%' then 1 else 0 end as Q9h_i_need_more_information_before_i_can_tak,
...
Q5_po_What_is_your_role_as_an_HM_Principal_in_the_career_program,
Q5a_Ensure_timely_start_and_end_of_the_program,
Q5b_Ensure_dedicated_career_period_in_the_timetable,
Q5c_Regularly_observe_career_sessions,
Q5d_Ensure_student_participation_in_the_program,
Q5e_Share_program_updates_in_HM,
Q5f_Promote_discussions_with_parents_about_students,
Q5g_Ensure_a_trained_career_teacher_is_in_place,
Q5h_Discuss_student_progress_with_the_career_teacher,
Q5i_Arrange_workplace_visits_external_speakers_or_career_fairs_to_provide_students_with_career_exposure,
Q5j_Engage_alumni_to_share_their_career_journeys,
Q5k_Allocate_school_resources_budget_for_the_program,
Q5l_Provide_feedback_to_the_career_teacher_facilitator,
Q5m_Attend_training_on_career_guidance_program,
Q5n_Share_career_related_information_with_parents,
Q5o_I_am_not_sure_about_my_role,
Q6_po_which_follow,
...
Q6_po_The_orientation_covered_all_the_key_information_about_the_career_program,
Q7_po_role,
...
Q7_po_The_content_was_easy_to_understand,
Q8_po_materials,
...
Q8_po_The_information_provided_was_relevant_to_my_role,
Q9_po_confidence,
Q9_po_In_the_next_30_da_take_for_the_program,
Q9a_allocate_timetable_time_for_career_sessi,
Q9b_observe_a_career_session,
Q9c_speak_to_parents_about_the_program,
Q9d_identify_a_teacher__poc__to_implement_co,
Q9e_set_up_a_joint_meeting_with_the_poc_teac,
Q9f_review_student_aspiration_data_with_care,
Q9g_attend_program_review__progress_meetings,
Q9h_i_need_more_information_before_i_can_tak,
