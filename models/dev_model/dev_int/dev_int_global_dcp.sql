...
t0 AS (
    SELECT
        ...
        b.batch_grade, b.batch_language, b.no_of_students_facilitated, b.fac_start_date, b.fac_end_date, b.allocation_email_sent, 
        b.batch_facilitator_id, f.facilitator_id, f.facilitator_name, f.facilitator_email,
        b.batch_school_id, s.school_id, s.school_name, s.school_taluka, s.school_ward, s.school_district, s.school_state, 
        s.school_academic_year, s.school_language, s.enrolled_g9, s.enrolled_g10, s.enrolled_g11, s.enrolled_g12, 
        s.tagged_for_counselling, s.school_partner, s.school_area, b.batch_donor_id, d.donor_id,
...
t1 AS (
    SELECT
        s.student_id, s.student_name, s.gender, s.birth_year, s.birth_date,
        g.student_grade,
        g.student_barcode,
        g.student_batch_id,
        g.whatsapp_no,
        ...
        s.first_barcode, s.current_barcode, s.current_batch_no,
        s.current_grade1, s.current_grade2, s.religion, s.caste,
        s.father_education, s.father_occupation, s.mother_education, s.mother_occupation,
        s.possible_career_report, s.career_tracks, s.clarity_report, s.current_aspiration,
        s.possible_careers_1, s.possible_careers_2, s.possible_careers_3,
        s.followup_1_aspiration, s.followup_2_aspiration,
        s.reality_1, s.reality_2, s.reality_3, s.reality_4, s.g9_alternate_no, s.g10_alternate_no, s.g11_alternate_no, s.g12_alternate_no,
        s.reality_5, s.reality_6, s.reality_7, s.reality_8, s.g9_whatsapp_no, g10_whatsapp_no, g11_whatsapp_no, g12_whatsapp_no,
        s.recommedation_status, s.recommendation_report_status, s.student_details_2_submitted,
        s.g9_barcode, s.g10_barcode, s.g11_barcode, s.g12_barcode
...
SELECT
    ...
    fs.current_grade1, fs.current_grade2, fs.religion, fs.caste, fs.father_education, fs.father_occupation, fs.g9_alternate_no,
    fs.g10_alternate_no, fs.g11_alternate_no, fs.g12_alternate_no,
    fs.mother_education, fs.mother_occupation, fs.possible_career_report, fs.career_tracks, fs.clarity_report, 
    fs.current_aspiration, fs.possible_careers_1, fs.possible_careers_2, fs.possible_careers_3, fs.followup_1_aspiration, 
    fs.followup_2_aspiration, fs.reality_1, fs.reality_2, fs.reality_3, fs.reality_4, fs.reality_5, fs.reality_6, 
    fs.reality_7, fs.reality_8, fs.recommedation_status, fs.recommendation_report_status, fs.student_details_2_submitted,

    -- Derived columns
    (
        CASE 
            WHEN fs.g9_barcode IS NOT NULL THEN 1
